...
// I am creating three seperate varaibles to hold the (3) 
// !! come back to this one, the variable here is not capturing the right pokemon, it is catching the one before the requested property
const caterpie = pokemon[9]
const abra = pokemon[62]
const grimer = pokemon[87]
game.party.push(caterpie, abra, grimer);
